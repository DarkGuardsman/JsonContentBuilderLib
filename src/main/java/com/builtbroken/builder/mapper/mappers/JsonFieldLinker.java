 ...
 */
public class JsonFieldLinker extends JsonMapper<Object>
{

    private final Field field;
    private final boolean required;

    public JsonFieldLinker(Field field, JsonMapping mapping)
    {
        this(field, mapping.keys(), mapping.type(), mapping.args(), mapping.required());
    }

    public JsonFieldLinker(Field field, String[] names, String type, String[] args, boolean required)
    {
